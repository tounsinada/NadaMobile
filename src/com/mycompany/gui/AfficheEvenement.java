                        ...
                        public void actionPerformed(ActionEvent evt) {
                            if (Integer.parseInt(tfNbTicket.getText()) > 0) {
                                if (Integer.parseInt(tfNbTicket.getText()) < i.getTicket_disponible()) {
                                  //  Dialog.show("hey youuuu", "This is the dialog body, it can contain anything...", "OK", "Cancel");
                                InteractionDialog dlg = new InteractionDialog("vous ne pouvez pas entrer un nombre de tickets inferieur à ");
